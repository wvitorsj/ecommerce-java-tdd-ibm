 ...
 * 
 * @Test
 * void rotaClientesGET() throws URISyntaxException, IOException,
 ...
 * 
 * @Test
 * void rotaClientesPOST() throws URISyntaxException, IOException,
 * InterruptedException {
 ...
 * 
 * @Test
 * void rotaClientesPUT() throws URISyntaxException, IOException,
 * InterruptedException {
 * var cliente = new Cliente();
 * cliente.setNome("Danilo");
 * cliente.setEmail("danilo@teste.com");
 ...
 * 
 * @Test
 * void rotaClientesDELETE() throws URISyntaxException, IOException,
 * InterruptedException {
 * var cliente = new Cliente();
 * cliente.setNome("Danilo");
 * cliente.setEmail("danilo@teste.com");
